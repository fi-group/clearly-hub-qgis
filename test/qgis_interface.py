...
__copyright__ = (
    ...
    'Copyright (c) 2011 German Carrillo, geotux_tuxman@linuxmail.org and '
    'Copyright (c) 2014 Tim Sutton, tim@linfiniti.com'
)
...
class QgisInterface(QObject):
    ...
    def __init__(self, canvas):
        ...
        # Keep compatibility across QGIS versions where this signal may vary.
        if hasattr(project, 'removeAll'):
            # noinspection PyArgumentList
    ...
    def addLayers(self, layers):
        ...
        self._set_canvas_layers(final_layers)
    ...
    def removeAllLayers(self):
        ...
        self._set_canvas_layers([])

    def _set_canvas_layers(self, layers):
        """Set map canvas layers across QGIS API variants."""
