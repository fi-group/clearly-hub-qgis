...
def dataset_metadata_payload(dataset, dataset_info):
    ...
    resource = dataset_info.get("resources", [{}])[0] if dataset_info.get("resources") else {}
...
def apply_layer_metadata(layer, metadata):
    ...
    layer.setCustomProperty("clearlyhub/hub_name", metadata.get("hub_name", ""))
    layer.setCustomProperty("clearlyhub/hub_id", metadata.get("hub_id", ""))
    layer.setCustomProperty("clearlyhub/resource_id", metadata.get("resource_id", ""))
    layer.setCustomProperty("clearlyhub/resource_name", metadata.get("resource_name", ""))
    layer.setCustomProperty("clearlyhub/resource_url", metadata.get("resource_url", ""))
    layer.setCustomProperty("clearlyhub/format", metadata.get("format", ""))
    layer.setCustomProperty("clearlyhub/findability", metadata.get("findability", ""))
